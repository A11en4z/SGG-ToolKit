...
_C.MODEL.ROI_RELATION_HEAD.BCKM = CN()
_C.MODEL.ROI_RELATION_HEAD.BCKM.FUSION_TYPE = "v2"
_C.MODEL.ROI_RELATION_HEAD.BCKM.USE_KNOWLEDGE = True
_C.MODEL.ROI_RELATION_HEAD.BCKM.KNOWLEDGE_DIM = 768
_C.MODEL.ROI_RELATION_HEAD.BCKM.KNOWLEDGE_DROP = 0.1
_C.MODEL.ROI_RELATION_HEAD.BCKM.PROTOTYPE_TYPE = "clip_residual"
_C.MODEL.ROI_RELATION_HEAD.BCKM.PROTOTYPE_RESIDUAL_L2_WEIGHT = 0.0
_C.MODEL.ROI_RELATION_HEAD.BCKM.PROTOTYPE_DIST_LOSS2_2_WEIGHT = 0.01
_C.MODEL.ROI_RELATION_HEAD.BCKM.PROTOTYPE_DIST_LOSS2_EXCLUDE_BG = True
...
_C.SOLVER.SCHEDULE.TYPE = "WarmupMultiStepLR"  # "WarmupReduceLROnPlateau", "WarmupCosineAnnealingLR"
...
_C.SOLVER.SCHEDULE.T_MAX = 0
_C.SOLVER.SCHEDULE.ETA_MIN = 0.0
