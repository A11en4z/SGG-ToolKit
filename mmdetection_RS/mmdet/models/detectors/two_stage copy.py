...
class TwoStageDetector(BaseDetector):
    ...
    def forward_train(self,
        ...
        roi_losses = self.global_roi_head.forward_train(
            x, img_metas, proposal_list, g_gt_boxes, g_gt_labels,
    ...
    def Test_Patches_Img(self,
        ...
        bbox_list = merge_results_two_stage_hbb(
            local_bboxes_lists, iou_thr=0.4)
    ...
    def Test_Concat_Patches_GlobalImg(self,
        ...
        for i in range(img.shape[0]):
            ...
            while j < len(p_imgs[i]):
                ...
                with torch.no_grad():
                    ...
                    if proposals is None:
                        proposal_list = self.global_rpn_head.simple_test_rpn(
        ...
        patches_bboxes_list = merge_results_two_stage_hbb(
            patches_bboxes_lists, iou_thr=0.4)
        # print('scale:',scale)
...
# #
    ...
    def simple_test(self, img, img_metas, proposals=None, rescale=False):
        ...
        bbox_list = merge_results_tensor_hbb(
            all_bboxes_lists, iou_thr=0.5).cpu()
        print(bbox_list)
