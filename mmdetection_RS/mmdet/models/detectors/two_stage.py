...
class TwoStageDetector(BaseDetector):
    ...
    def Test_Patches_Img(self,
        ...
        bbox_list, p_keeps = merge_results_two_stage_hbb(
    ...
    def Test_Concat_Patches_GlobalImg(self,
        ...
        if (ori_img.shape[2] > 12000 or ori_img.shape[3] > 12000):
            ...
            img = F.interpolate(
                ori_img_cpu, scale_factor=1 / scale, mode='bilinear')
            img = img.to(device)
            print("move to gpu done!")
        else:
            img = F.interpolate(
                ori_img, scale_factor=1 / scale, mode='bilinear')
    ...
    # img = F.interpolate(ori_img, scale_factor=1 / scale, mode='bilinear')
        ...
        patches_bboxes_list, p_keeps = merge_results_two_stage_hbb(
